...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 05 dec 2018 om 13:33
...
ALTER TABLE `countries`
  ...
  ADD KEY `fk_countries_regions_idx` (`region_id`);
...
ALTER TABLE `departments`
  ...
  ADD KEY `fk_departments_locations1_idx` (`location_id`);
...
--
-- Indexen voor tabel `job_grades`
--
ALTER TABLE `job_grades`
  ADD PRIMARY KEY (`grade_level`),
  ADD UNIQUE KEY `grade_UNIQUE` (`grade_level`);
...
ALTER TABLE `job_history`
  ...
  ADD KEY `fk_job_history_jobs1_idx` (`job_id`),
  ADD KEY `fk_job_history_departments1_idx` (`department_id`);
...
--
ALTER TABLE `departments`
  MODIFY `department_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
...
--
ALTER TABLE `countries`
  ADD CONSTRAINT `fk_countries_regions` FOREIGN KEY (`region_id`) REFERENCES `regions` (`region_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `departments`
--
ALTER TABLE `departments`
  ADD CONSTRAINT `fk_departments_locations1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Beperkingen voor tabel `job_history`
--
ALTER TABLE `job_history`
  ADD CONSTRAINT `fk_job_history_departments1` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_job_history_jobs1` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`job_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `locations`
--
ALTER TABLE `locations`
  ADD CONSTRAINT `fk_locations_countries1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
